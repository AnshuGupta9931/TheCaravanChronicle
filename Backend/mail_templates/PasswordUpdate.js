export const passwordUpdated = (email, name) => {
    ...
    <body>
        <div class="container">
            <a href="https://digitledger.io">
                <img class="logo" src="https://i.ibb.co/MR2qk2D/digit-ledger-logo.png" alt="Digit Ledger Logo">
            </a>
            ...
            <div class="support">
                ...
                <a href="mailto:support@digitledger.io">support@digitledger.io</a>. We're here to help!
            </div>
        </div>
    </body>
